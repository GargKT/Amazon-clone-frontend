...
export function updateCheckoutQuantity() {
    ...
    document.querySelector('.js-number-of-items').innerHTML = cartQuantity;
}
        ...
        js-cart-item-container-${matchingProduct.id}">
            ...
            <div class="cart-item-details-grid">
                ...
                js-product-quantity-${matchingProduct.id}">
                    ...
                    <input class="quantity-input js-quantity-input-${matchingProduct.id}" type = "number" min="1" max="100">
    ...
    document.querySelectorAll('.js-save-link').forEach((link) => {
        link.addEventListener('click', () => {
            ...
            if(newQuantity < 0 || newQuantity >=100){
                alert('Quantity must be in between 1 and 100');
                return;
            }
